...
function Images() {
  ...
  return (
    <div>
      ...
      <div className="grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-col-5 px-0 md:px-10">
        {images?.imageUrls?.map((image: ImageType, i: number) => (
          <div
            ...
            `}
          >
            {/* create a white div that hovered it appears*/}
            ...
            <Image
              ...
              height={800}
              width={800}
              className="w-full rounded-sm shadow-2x1 drop-shadow-lg -z-10"
            />
          </div>
        ))}
      </div>
